...
<tr>
	...
	<td>
		<input type="hidden" name="upload_ajax_<?php echo esc_attr( $name ); ?>" value="<?php echo wp_create_nonce( 'upload-' . $post->ID . $name ); ?>" />
		<input 
			type="text" 
		...
		/>
		<br/>
		<button id="upload_ajax_<?php echo esc_attr( $name ); ?>" class="button-secondary wpcf-upload-ajax-button">Upload</button>
